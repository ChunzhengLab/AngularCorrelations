...
AliAnalysisTaskPIDAngCorr* AddTaskPIDAngCorr(
...
{  
  ...
  if (!mgr) {
    Error("AddTaskPIDAngCorr.C", "No analysis manager to connect to.");
    return NULL;
  }
  ...
  if (!mgr->GetInputEventHandler()) {
    Error("AddTaskPIDAngCorr.C", "This task requires an input event handler.");
    return NULL;
  }
  //TString type = mgr->GetInputEventHandler()->GetDataType(); // can be "ESD" or "AOD"

  // --- instantiate analysis task
  AliAnalysisTaskPIDAngCorr *task = new AliAnalysisTaskPIDAngCorr("TaskAngCorr");
  task->SetDebug(debug);
  ...
  //     fNUEFile = TFile::Open("../CalibFiles/LHC18r/efficiencyBothpol18qnew.root","READ");
  //     fListNUE = dynamic_cast <TList*> (fNUEFile->Get("fMcEffiHij"));
  //   }
  //   if(fListNUE) {
  ...
  //   }
  //   if (period.EqualTo("LHC18r")) {
  //     fNUAFile = TFile::Open("../CalibFiles/LHC18r/WgtsNUAChargeAndPion_LHC18rPass3_FB768_AlexPU_DeftMode_Sept2021NoAvgQ.root","READ");
  //     fListNUA = dynamic_cast <TList*> (fNUAFile->Get("fNUA_ChPosChNeg"));
  //   }
  //   if(fListNUA) {
  ...
  //   }
  //   if (period.EqualTo("LHC18r")) {
  //     fVZEROCalibFile = TFile::Open("../CalibFiles/LHC18r/calibSpq2V0C18rP3.root","READ");
  //     fVZEROCalibList = dynamic_cast <TList*> (fVZEROCalibFile->Get("fWgtsV0ZDC"));
  //   }
  //   if(fVZEROCalibList) {
  ...
  //   // }
  //   if (period.EqualTo("LHC18q")) {
  //     fZDCCalibFile = TFile::Open("../CalibFiles/LHC18q/RecenteringResultFinal_2018q.root","READ");
  //     fZDCCalibList = dynamic_cast <TList*> (fZDCCalibFile->Get("fOutputRecenter"));
  //   }
  //   if (period.EqualTo("LHC18r")) {
  //     fZDCCalibFile = TFile::Open("../CalibFiles/LHC18r/RecenteringResultFinal_2018r.root","READ");
  //     fZDCCalibList = dynamic_cast <TList*> (fZDCCalibFile->Get("fOutputRecenter"));
  //   }
  //   if(fZDCCalibList) {
